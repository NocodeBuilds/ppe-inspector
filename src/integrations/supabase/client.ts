...
// Export types from our types file for compatibility
export type { PPEItem, PPEStatus, PPEType, InspectionType, UserRole, Profile, User, Inspection, InspectionResult, InspectionCheckpoint } from '@/types';
