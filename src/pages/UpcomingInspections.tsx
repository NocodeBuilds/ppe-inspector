...
const UpcomingInspections = () => {
  ...
  const [upcomingItems, setUpcomingItems] = useState<PPEItem[]>([]);
  ...
  const fetchUpcomingInspections = async () => {
    try {
      ...
      // Get items with upcoming inspections
  ...
  const handleInspect = (item: PPEItem) => {
    ...
    // In a real app, we would navigate to inspection form
    toast({
      title: 'Start Inspection',
      description: `Inspecting ${item.type} (${item.serial_number})`,
    });
  };
